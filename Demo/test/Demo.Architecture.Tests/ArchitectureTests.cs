...
{
    private const string DomainNamespace = "Demo.Domain";
    private const string ApplicationNamespace = "Demo.Application";
    private const string InfrastructureNamespace = "Demo.Infrastructure";
    private const string PersistenceNamespace = "Demo.Persistence";
    private const string PresentationNamespace = "Demo.Presentation";
    private const string ApiNamespace = "Demo.API";
